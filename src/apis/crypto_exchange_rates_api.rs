...
/// struct for typed errors of method [`get_exchange_rates`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetExchangeRatesError {
...
pub async fn get_exchange_rates(configuration: &configuration::Configuration, trading_pair: &str) -> Result<models::GetExchangeRatesResponse, Error<GetExchangeRatesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetExchangeRatesError> = serde_json::from_str(&local_var_content).ok();
