...
impl PixFiatAccountCreationRequest {
    pub fn new(idempotency_key: uuid::Uuid, name: String, account_number: String, ispb: String, tax_id: String, account_type: models::PixAccountType) -> PixFiatAccountCreationRequest {
