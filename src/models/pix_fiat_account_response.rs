...
impl PixFiatAccountResponse {
    pub fn new(id: uuid::Uuid, status: models::ExternalFiatAccountStatus, description: String, tracking_ref: String, transfer_types_info: std::collections::HashMap<String, models::TransferTypeInfo>, fingerprint: String, create_date: String, update_date: String) -> PixFiatAccountResponse {
