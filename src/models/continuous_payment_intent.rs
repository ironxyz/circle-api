...
pub struct ContinuousPaymentIntent {
...
impl ContinuousPaymentIntent {
    pub fn new(currency: Currency, settlement_currency: SettlementCurrency, payment_methods: Vec<models::PaymentMethodBlockchain>, r#type: Type) -> ContinuousPaymentIntent {
