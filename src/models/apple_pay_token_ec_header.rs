...
pub struct ApplePayTokenEcHeader {
...
impl ApplePayTokenEcHeader {
    pub fn new(ephemeral_public_key: String, public_key_hash: String, transaction_id: String) -> ApplePayTokenEcHeader {
