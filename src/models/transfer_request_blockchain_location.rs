...
pub struct TransferRequestBlockchainLocation {
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl TransferRequestBlockchainLocation {
    pub fn new(r#type: Type, address: String, chain: models::Chain) -> TransferRequestBlockchainLocation {
